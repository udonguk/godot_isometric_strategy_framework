...
- [x] 게임 실행 (F5)
- [x] 유닛1 클릭
  - [x] 유닛1이 선택되는지 확인 (시각적 피드백)
  - [x] 로그: `[InputManager] 유닛 클릭: UnitEntity` 출력 확인
- [x] 다른 유닛2 클릭
  - [x] 유닛1 선택 해제 확인
  - [x] 유닛2 선택 확인
- [x] **통과 기준**: 한 번에 하나의 유닛만 선택됨

### TC-2: 유닛 다중 선택 (Ctrl+클릭)

- [x] Ctrl 키를 누른 상태로 유닛1 클릭
  - [x] 유닛1 선택 확인
- [x] Ctrl 키를 누른 상태로 유닛2 클릭
  - [x] 유닛1, 유닛2 **모두** 선택 확인
  - [x] 로그: `[SelectionManager] 유닛 선택됨 (총 2개)` 출력 확인
- [x] Ctrl 키를 누른 상태로 유닛3 클릭
  - [x] 유닛1, 2, 3 모두 선택 확인
- [x] **통과 기준**: 다중 선택이 정상 작동, 기존 선택 유지됨

### TC-3: 건물 선택

- [x] 건물 클릭
  - [x] 건물이 선택되는지 확인 (빨간 화살표 인디케이터 표시)
  - [x] 로그: `[InputManager] 건물 클릭: BuildingEntity` 출력 확인
- [x] 유닛 선택 후 건물 클릭
  - [x] 유닛 선택 해제 확인
  - [x] 건물 선택 확인
- [x] **통과 기준**: 건물과 유닛은 동시에 선택되지 않음
...
- [x] 빈 공간(땅) 클릭
  - [x] 모든 선택 해제 확인
  - [x] 로그: `[InputManager] 빈 공간 클릭` 출력 확인
  - [x] **중요**: 로그가 **한 번만** 출력되는지 확인 (중복 없음!)
- [x] 건물 선택
- [x] 빈 공간 클릭
  - [x] 건물 선택 해제 확인
- [x] **통과 기준**: 빈 공간 클릭 시 로그 중복 없음

### TC-5: 우선순위 검증

- [x] 씬 에디터에서 유닛과 건물을 겹치는 위치에 배치
- [x] 게임 실행
- [x] 겹친 위치 클릭
  - [x] 유닛이 선택되는지 확인 (**유닛 우선**)
  - [x] 로그: `[InputManager] 유닛 클릭` 출력 (건물 아님!)
- [x] **통과 기준**: 유닛 > 건물 우선순위 정상 작동

### TC-6: 이동 명령 (우클릭)

- [x] 유닛 선택
- [x] 땅 위에 우클릭
  - [x] 유닛이 클릭 위치로 이동하는지 확인
- [x] 여러 유닛 선택 (Ctrl+클릭)
- [x] 땅 위에 우클릭
  - [x] **모든** 선택된 유닛이 이동하는지 확인
- [x] **통과 기준**: 이동 명령 정상 작동

### TC-7: 회귀 테스트 (기존 기능 보존)

- [x] 게임의 다른 기능들이 정상 작동하는지 확인:
  - [x] 카메라 이동 (WASD)
  - [ ] 카메라 줌 (마우스 휠)
  - [ ] 기타 게임 로직
